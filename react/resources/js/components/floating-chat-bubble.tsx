    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-96 h-[600px] flex flex-col rounded-2xl bg-white dark:bg-slate-900 shadow-2xl border border-gray-200 dark:border-slate-700">
          ...
          {/* Footer */}
          <div className="border-t p-4 bg-white dark:bg-slate-900 rounded-b-2xl">
            <button
              onClick={() => {
                window.location.href = "/laporan-bug"
                setIsOpen(false)
              }}
              className="w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium transition"
            >
