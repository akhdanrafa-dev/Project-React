    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                ...
                if (!response.ok)
                    throw new Error('Failed to fetch admin activity stats');
        ...
        <header className="flex h-16 items-center gap-2 border-b border-border bg-background px-4">
            ...
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/admin-it/ranking-admin">
                            Ranking Admin IT
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            ...
            <div className="flex flex-1 flex-col gap-6 p-6">
                <div>
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Peringkat admin IT berdasarkan aktivitas dan performa
                        penanganan tiket
                    </p>
                </div>
                            ...
                            return (
                                ...
                                >
                                    <CardHeader className="text-center">
                                        ...
                                        <Badge
                                            className={`mx-auto mt-2 w-fit ${activity.color}`}
                                        >
                                            {activity.label}
                                        </Badge>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2 border-t pt-3 text-sm">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                >
                                                    {admin.performance_score.toFixed(
                                                        1,
                                                    )}
                                                </Badge>
                                            </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    {sortedStats.reduce(
                                        (sum, admin) => sum + admin.this_month,
                                        0,
                                    )}
                                </div>
                                <p className="text-xs text-muted-foreground">
                                    Ditangani dalam sebulan
                                </p>
                            </CardContent>
                        </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Peringkat berdasarkan aktivitas bulan ini dan
                            performa penanganan tiket
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                        ...
                                        return (
                                            <TableRow key={admin.id}>
                                                ...
                                                <TableCell className="text-center text-sm">
                                                    {admin.average_resolution_hours.toFixed(
                                                        1,
                                                    )}
                                                    h
                                                </TableCell>
                        ...
                        <div className="grid gap-3 md:grid-cols-1">
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    Minimal 3 tiket selesai per hari (rata-rata
                                    2 hari terakhir)
                                </span>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    Minimal 1 tiket selesai per hari (rata-rata
                                    2 hari terakhir)
                                </span>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-muted-foreground">
                                    Tidak ada tiket selesai dalam 2 hari
                                    terakhir atau rata-rata kurang dari 1 tiket
                                    per hari
                                </span>
                            </div>
                        </div>
                    ...
                    <CardContent className="space-y-3">
                        <div className="space-y-2">
                            ...
                            <p className="ml-7 text-sm text-muted-foreground">
                                Kombinasi dari resolution rate (70%) dan
                                kecepatan penyelesaian (30%)
                            </p>
                        </div>
                        <div className="space-y-2">
                            <div className="flex items-center gap-2">
                            ...
                            <p className="ml-7 text-sm text-muted-foreground">
                                Persentase tiket yang sudah terselesaikan dari
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="ml-7 text-sm text-muted-foreground">
                                Rata-rata jam yang dihabiskan untuk
                                menyelesaikan satu tiket (semakin cepat semakin
                                baik)
                            </p>
                        </div>
                    </CardContent>
